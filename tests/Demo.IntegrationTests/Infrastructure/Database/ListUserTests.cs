...
public class ListUserTests : IClassFixture<ServicesFixture>
{
    private readonly IServiceProvider _services;

    public ListUserTests(ServicesFixture services, ITestOutputHelper outputHelper)
    {
    ...
    [Fact]
    public async Task Added_user_can_be_found_in_list()
    {
        // arrange
